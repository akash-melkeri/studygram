          ...
          <div>
            ...
            <div class="tw-relative">
              ...
              <q-carousel
                ...
                class=""
              >
                <q-carousel-slide v-for="(content,index) in item.contents" :name="index" :key="content.id" class="text-red">
            ...
            <div>
              ...
              <div class="tw-flex tw-justify-between tw-p-2">
                <div class="tw-flex tw-gap-3">
                  <svg v-if="item.is_liked" xmlns="http://www.w3.org/2000/svg" class="tw-w-8 tw-h-8 tw-text-red-500" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M4.222 5.364A6.002 6.002 0 0 1 12 4.758a6.002 6.002 0 0 1 7.778 9.091l-5.657 5.657a3 3 0 0 1-4.242 0L4.222 13.85a6 6 0 0 1 0-8.485Z" clip-rule="evenodd"/></svg>
                  <svg v-else xmlns="http://www.w3.org/2000/svg" class="tw-w-8 tw-h-8" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.071 13.142L13.414 18.8a2 2 0 0 1-2.828 0l-5.657-5.657A5 5 0 1 1 12 6.072a5 5 0 0 1 7.071 7.07Z"/></svg>
                  <svg xmlns="http://www.w3.org/2000/svg" class="tw-w-8 tw-h-8" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21a9 9 0 1 0-9-9c0 1.488.36 2.891 1 4.127L3 21l4.873-1c1.236.64 2.64 1 4.127 1Z"/></svg>
                  <svg xmlns="http://www.w3.org/2000/svg" class="tw-w-8 tw-h-8" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 12l-.604-5.437C4.223 5.007 5.825 3.864 7.24 4.535l11.944 5.658c1.525.722 1.525 2.892 0 3.614L7.24 19.465c-1.415.67-3.017-.472-2.844-2.028L5 12Zm0 0h7"/></svg>
                </div>
                <div>
                  <svg v-if="item.is_saved" xmlns="http://www.w3.org/2000/svg" class="tw-w-8 tw-h-8" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M8 2a3 3 0 0 0-3 3v16a1 1 0 0 0 1.447.894L12 19.118l5.553 2.776A1 1 0 0 0 19 21V5a3 3 0 0 0-3-3H8Z" clip-rule="evenodd"/></svg>
                  <svg v-else xmlns="http://www.w3.org/2000/svg" class="tw-w-8 tw-h-8" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 3H8a2 2 0 0 0-2 2v16l6-3l6 3V5a2 2 0 0 0-2-2Z"/></svg>
                </div>
              </div>
              <div>
                <div>Likes</div>
